...
public interface LimitViolationDetector {
     ...
     */
    void checkCurrent(Contingency contingency, Branch branch, Branch.Side side, double currentValue, Consumer<LimitViolation> consumer);
     ...
     * @param consumer      Will be fed with possibly created limit violations.
     */
    void checkCurrent(Contingency contingency, Branch branch, Branch.Side side, Consumer<LimitViolation> consumer);
     ...
     * @param consumer      Will be fed with possibly created limit violations.
     */
    void checkVoltage(Contingency contingency, Bus bus, double voltageValue, Consumer<LimitViolation> consumer);
     ...
     * @param consumer      Will be fed with possibly created limit violations.
     */
    void checkVoltage(Contingency contingency, Bus bus, Consumer<LimitViolation> consumer);
     ...
     * @param consumer      Will be fed with possibly created limit violations.
     */
    void checkVoltage(Contingency contingency, VoltageLevel voltageLevel, Consumer<LimitViolation> consumer);
     ...
     * @param consumer      Will be fed with possibly created limit violations.
     */
    void checkCurrent(Contingency contingency, Branch branch, Consumer<LimitViolation> consumer);
     ...
     * @param consumer      Will be fed with possibly created limit violations.
     */
    void checkAll(Contingency contingency, Network network, Consumer<LimitViolation> consumer);
}
